 ...
 */
package com.inosystem.pdv.conexoes;
...
public class ConexaoMySql {
    ...
    public Connection conectar() {
        try {
            ...
            String url = "jdbc:mysql://" + sessaoUsuario.ipServidor + "/" + sessaoUsuario.nomeDoBanco;
            this.setCon((Connection) DriverManager.getConnection(url, sessaoUsuario.usuarioBanco, sessaoUsuario.senhaBanco));
    ...
    public Connection conectarSemBanco() {
        try {
            ...
            //local do banco, nome do banco, usuario e senha
            String url = "jdbc:mysql://" + sessaoUsuario.ipServidor;
            this.setCon((Connection) DriverManager.getConnection(url, sessaoUsuario.usuarioBanco, sessaoUsuario.senhaBanco));
